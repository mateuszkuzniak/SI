...
\begin{itemize}
    \item ograniczenie zapewniające, że każdy krok jest różny (żadna para kroków nie ma takich samych współrzędnych),
    \item ograniczenie ustalające ilość punktów na każdym kroku rozwiązania,
    \item ograniczenie zliczające sumę punktów zdobytych dla danego rozwiązania,
    \item ograniczenie sprawdzające czy pole niedozwolone nie znajduje się w rozwiązaniu,
    \item ograniczenie sprawdzające, że kolejny krok jest w bezpośrednim kontakcie z obecnym (tzn. w odległości jednego pola nie wliczając przekątnych),
    \item ograniczenie sprawdzjące czy ostatni krok w rozwiązaniu znajduje się w bezpośrenim kontakcie z pierwszym krokiem, w celu zamknięcia pętli.
\end{itemize}
